    ...
    <auth-admin>
      <template v-slot:content>
        <div class="content">
          ...
          <!--============== Invoices Table ================-->
          <empty-resource v-if="invoices.data.length === 0"></empty-resource>
                ...
                <tr v-for="invoice in invoices.data" :key="invoice.id">
                  ...
                  <td>
                    ...
                    <button
                      class="btn btn-sm btn-aura"
                      v-else
                      @click.prevent="restoreInvoice(invoice.id)"
                    >
          ...
          <modal v-if="showModal" @close="showModal = false">
            <h5 slot="header" class="text-dark text-center">Edit Invoice</h5>
            <div slot="body">
