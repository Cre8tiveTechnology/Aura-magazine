        ...
        <div class="content">
          ...
          <form action="POST">
            ...
            <div class="mt-4">
              ...
              <div class="form-group">
                <textarea name="" id="" class="input-control form-control">
            ...
            <div class="container-fluid p-0 m-0">
              <div class="row">
                ...
                <div class="col-md-6 mt-5">
                  ...
                  <select name="" id="" class="form-control input-control">
                    <optgroup label="Culture">
                      <option value="ll">Love and Hope</option>
                      <option value="oo">Horoscope</option>
                    </optgroup>
  ...
  data: () => ({
    ...
    myOptions: {
      ...
      items: {
        ...
        disabled: false,
        labels: [
          { name: "Landscape", color: "white", backgroundColor: "pink" },
          { name: "Portrait", color: "white", backgroundColor: "black" },
        ],
      },
    },
  }),
