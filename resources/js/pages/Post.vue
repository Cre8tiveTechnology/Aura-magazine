    ...
    <div class="container sp-mt-7">
      <div class="row">
        ...
        <div class="col-12 col-lg-8 col-md-8 col-sm-12">
          ...
          <!-- IMAGES -->
          <div class="container-fluid p-0 mt-4" v-show="this.images.length > 0">
            ...
            <div class="row justify-content-between">
              <div
                ...
                :key="post"
              >
                <a data-fancybox="gallery" :href="post">
                  <img
                    :src="post"
                    :alt="article.title"
                    class="col-12 p-0 img-fluid"
...
.whatSappBtn:before {
  font-family: "FontAwesome";
  content: "\f232"; /* add linkedin icon */
}
