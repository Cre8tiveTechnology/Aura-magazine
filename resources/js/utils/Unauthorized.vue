        ...
        <div class="body">
          ...
          >
            <defs>
              ...
              <text id="text-s" class="error-text" y="106">_0_</text>
            </defs>
            <path
              class="alarm"
              fill="#e62326"
          ...
          <h1 class="mt-5">
            <i class="fa fa-info-circle"></i> Oops! You are not allowed here.
          </h1>
          <h2>
            <span @click="$router.go(-1)" class="btn btn-sm btn-aura">
