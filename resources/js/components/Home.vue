<template>
  <div>
    ...
    >
      <!-- Heading -->
      <h5 class="aura-font font-weight-bold ml-0 mt-4 text-white">
        Top Stories
          ...
          <div class="carousel-item active">
            <div class="card w-100 border-0">
              ...
              <div
                ...
                style="background-color:#676465 !important;"
              >
                <h4 class="card-title aura-font" style="font-size:30px;">
    ...
    <div class="container-fluid p-5" style="background-color:#676465 !important;">
      <!-- Desktop Carousel -->
      <div
        id="carouselExampleSlidesOnly"
        class="carousel slide w-75 mx-auto rounded d-none d-md-block d-lg-block d-xl-block"
        data-ride="carousel"
      >
        <h5 class="aura-font font-weight-bold ml-0 mt-4 text-white">
          Top Stories
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <div class="card w-100 border-0">
              ...
              />
              <div
                class="card-body text-white text-center border-0"
                style="background-color:#676465 !important;"
              >
                <h4 class="card-title aura-font" style="font-size:30px;">
                  Being Everywoman Is Katie Porter's
        ...
        <div class="col-12 col-sm-10 col-md-6 col-lg-3">
          <div class="card p-3">
            ...
            <div class="card-body px-0">
              <p
                class="story-card-font-1"
              >Excepteur sint occaecat cupidatatnon proident, sunt in culpa qui ocial deserunt mollit anim tujln.kaeei do.</p>
              <hr class="story-card-hr" />
              <p
                class="story-card-font-2"
              >Money to many is very thig wufr ubneuid nqhfioef aeuaean qoi4ii JOECAER UJCUIW</p>
            </div>
          </div>
        </div>
    ...
    <div class="container w-75 mx-auto">
      <h5 class="news headline-font font-weight-bolder ml-0">
        <span class="text-aura" style="font-size:30px;">+</span> NEWS
      </h5>
      <div class="row no-gutters justify-content-center">
        ...
        <div class="col-sm-7 col-md-7 col-lg-7 col-xl-7">
          <div class="card mb-3 border-0 rounded-0">
            ...
            <div class="card-body">
              <h4
                class="card-title aura-font font-weight-bold"
                style="font-size:30px;"
              >Being Everywoman Is Katie Porter's Superpower</h4>
              <hr class="card-hr" />

              <!-- <div
                                class="container mt-5 mx-auto d-none d-md-block d-lg-block  d-xl-block"
                            >
                                <p class="text-center text-aura">
                                    SEE MORE
                                    <button
                                        type="button"
                                        class="btn btn-outline-aura btn-circle btn-sm"
                                    >
          ...
          <ul class="list-unstyled">
            <li class="media">
              ...
              <div class="media-body">
                <h5 class="mt-0 mb-1 aura-font">The Wing Still Has a Long Way To Go</h5>
              </div>
            </li>
            <li class="media my-1">
              <img
